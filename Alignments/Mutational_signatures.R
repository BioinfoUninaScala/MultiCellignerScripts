...
###### Load Data 
CCLE_mutations <- read.csv("/DATA/SCRATCH/scala/celligner/1_multiCellignerFinal/DATA/Mutational_process/CCLE_mutations.csv")
...
mut_pancancer <- readRDS("/DATA/SCRATCH/scala/celligner/1_multiCellignerFinal/DATA/Mutational_process/mut_pancancer.rds")
